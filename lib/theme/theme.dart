...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xfffdd6ff),
      onPrimaryContainer: Color(0xff603768),
      secondary: Color(0xff6b596c),
      ...
      inversePrimary: Color(0xffe9b5ef),
      primaryFixed: Color(0xfffdd6ff),
      onPrimaryFixed: Color(0xff300a39),
      primaryFixedDim: Color(0xffe9b5ef),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff794f81),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff623a6a),
      onPrimaryContainer: Color(0xffffffff),
      ...
      inverseSurface: Color(0xff342f34),
      inversePrimary: Color(0xffe9b5ef),
      primaryFixed: Color(0xff623a6a),
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff4a2352),
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff544456),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff3d2d3f),
      onSecondaryFixedVariant: Color(0xffffffff),
      ...
      surfaceContainerHigh: Color(0xffdcd1d9),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xffe9b5ef),
      surfaceTint: Color(0xffe9b5ef),
      onPrimary: Color(0xff472150),
      primaryContainer: Color(0xff603768),
      onPrimaryContainer: Color(0xfffdd6ff),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      primaryFixed: Color(0xfffdd6ff),
      onPrimaryFixed: Color(0xff24002e),
      primaryFixedDim: Color(0xffe9b5ef),
      onPrimaryFixedVariant: Color(0xff4e2756),
      secondaryFixed: Color(0xfff3dbf2),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xffe5b1eb),
      ...
      primaryFixedDim: Color(0xffe9b5ef),
      onPrimaryFixedVariant: Color(0xff24002e),
      secondaryFixed: Color(0xfff3dbf2),
